...
## Migration status
This is the new frontend, not a completed WordPress data migration. The original website and DNS have not been changed. Phone numbers confirmed by owner; LINE contact: https://lin.ee/rDlbQoC (provided by owner). Address and hours taken from original website; confirm before launch. Hero photo is AI-generated illustrative imagery, not an actual shop/team photo.
